...
cur.execute('''CREATE TABLE metgisAirport(
    lat char(100),
    lon char(100),
    alt char(100),
    sunrise char(100),
...
print("metgisAirport Created")
cur.execute('''CREATE TABLE openWeatherAirport(
    lat char(50),
    lon char(50),
    id1 char(50),
    main char(50),
...
print("openWeatherAirport Created")
cur.execute('''CREATE TABLE worldWeatherAirport(
    lat char(50),
    lon char(50),
    types char(50),
    querys char(50),
...
print("worldWeatherAirport Created")
