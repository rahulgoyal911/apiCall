        ...
        for row in reader:
                if(row[4]!='Altitude'):
                        ...
                        if(response.status_code==200):
                                ...
                                cur.execute(str1)
                                conn.commit()
                                print("inserted into metgisAIRPORT")
                        else:
