...
# newstr = oldstr.replace("M", "")
        ...
        str1 = "INSERT INTO METGIS (lat,lon,alt,sunrise,dayCount,weatherIcon,snowfall,unitLin,maxTemp,description,dateRequest,windDir,sunshineDuration,precipitaton,windIcon,windSpeed,lang,rainfall,unitWind,forecastIssued,minTemp,unitTemp,sunset,relativeHumidity,forecastShortText) VALUES('"+lat+"','"+lon+"','"+alt+"','"+sunrise+"','"+dayCount+"','"+weatherIcon+"','"+snowfall+"','"+unitLin+"','"+maxTemp+"','"+description+"','"+dateRequest+"','"+windDir+"','"+sunshineDuration+"','"+precipitaton+"','"+windIcon+"','"+windSpeed+"','"+lang+"','"+rainfall+"','"+unitWind+"','"+forecastIssued+"','"+minTemp+"','"+unitTemp+"','"+sunset+"','"+relativeHumidity+"','"+forecastShortText+"');"         
        cur.execute(str1)
        conn.commit()
