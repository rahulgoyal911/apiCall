...
# newstr = oldstr.replace("M", "")
        ...
        str1 = "INSERT INTO METGIS (lat,lon,alt,sunrise,dayCount,weatherIcon,snowfall,unitLin,maxTemp,description,dateRequest,windDir,sunshineDuration,precipitaton,windIcon,windSpeed,lang,rainfall,unitWind,forecastIssued,minTemp,unitTemp,sunset,relativeHumidity,forecastShortText) VALUES('"+lat+"','"+lon+"','"+alt+"','"+sunrise[0]+"','"+dayCount+"','"+weatherIcon[0]+"','"+snowfall[0]+"','"+unitLin+"','"+maxTemp[0]+"','"+description+"','"+dateRequest+"','"+windDir[0]+"','"+sunshineDuration+"','"+precipitaton[0]+"','"+windIcon[0]+"','"+windSpeed[0]+"','"+lang+"','"+rainfall[0]+"','"+unitWind+"','"+forecastIssued+"','"+minTemp[0]+"','"+unitTemp+"','"+sunset[0]+"','"+relativeHumidity+"','"+forecastShortText[0]+"');"         
        cur.execute(str1)
        str1 = "INSERT INTO METGIS (lat,lon,alt,sunrise,dayCount,weatherIcon,snowfall,unitLin,maxTemp,description,dateRequest,windDir,sunshineDuration,precipitaton,windIcon,windSpeed,lang,rainfall,unitWind,forecastIssued,minTemp,unitTemp,sunset,relativeHumidity,forecastShortText) VALUES('"+lat+"','"+lon+"','"+alt+"','"+sunrise[1]+"','"+dayCount+"','"+weatherIcon[1]+"','"+snowfall[1]+"','"+unitLin+"','"+maxTemp[1]+"','"+description+"','"+dateRequest+"','"+windDir[1]+"','"+sunshineDuration+"','"+precipitaton[1]+"','"+windIcon[1]+"','"+windSpeed[1]+"','"+lang+"','"+rainfall[1]+"','"+unitWind+"','"+forecastIssued+"','"+minTemp[1]+"','"+unitTemp+"','"+sunset[1]+"','"+relativeHumidity+"','"+forecastShortText[1]+"');"         
        cur.execute(str1)
        str1 = "INSERT INTO METGIS (lat,lon,alt,sunrise,dayCount,weatherIcon,snowfall,unitLin,maxTemp,description,dateRequest,windDir,sunshineDuration,precipitaton,windIcon,windSpeed,lang,rainfall,unitWind,forecastIssued,minTemp,unitTemp,sunset,relativeHumidity,forecastShortText) VALUES('"+lat+"','"+lon+"','"+alt+"','"+sunrise[2]+"','"+dayCount+"','"+weatherIcon[2]+"','"+snowfall[2]+"','"+unitLin+"','"+maxTemp[2]+"','"+description+"','"+dateRequest+"','"+windDir[2]+"','"+sunshineDuration+"','"+precipitaton[2]+"','"+windIcon[2]+"','"+windSpeed[2]+"','"+lang+"','"+rainfall[2]+"','"+unitWind+"','"+forecastIssued+"','"+minTemp[2]+"','"+unitTemp+"','"+sunset[2]+"','"+relativeHumidity+"','"+forecastShortText[2]+"');"         
        cur.execute(str1)
        conn.commit()
